...
#   - Ex: hexpm/elixir:1.14.4-erlang-25.2.3-debian-bullseye-20230202-slim
#
...
# compile assets
RUN chmod +x bin/bootstrap_asdf.sh && \
    bin/bootstrap_asdf.sh
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/hardcorehandyman ./

USER nobody

ENV ECTO_IPV6=true
ENV PHX_HOST="https://hardcorehandymanoflawton.com"
