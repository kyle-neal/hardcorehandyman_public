defmodule HardcorehandymanWeb.CoreComponents do
  @moduledoc """
  ...
  attr(:rows, :integer, default: 3, doc: "the number of rows for textarea inputs")
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HardcorehandymanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HardcorehandymanWeb.Gettext, "errors", msg, opts)
    end
  end
